 ...
 */
final class Version20250305155830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT DEFAULT NULL, CHANGE prix prix NUMERIC(10, 0) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, CHANGE prix prix INT NOT NULL');
    }
}
